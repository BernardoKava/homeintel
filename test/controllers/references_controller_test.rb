...
class ReferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post references_url, params: { reference: { active: @reference.active, details: @reference.details, email: @reference.email, employer: @reference.employer, person_id: @reference.person_id, referee: @reference.referee, telephone: @reference.telephone } }
    end
  ...
  test "should update reference" do
    patch reference_url(@reference), params: { reference: { active: @reference.active, details: @reference.details, email: @reference.email, employer: @reference.employer, person_id: @reference.person_id, referee: @reference.referee, telephone: @reference.telephone } }
