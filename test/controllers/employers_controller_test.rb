...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post employers_url, params: { employer: { active: @employer.active, name: @employer.name, sector: @employer.sector, user_id: @employer.user_id } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { active: @employer.active, name: @employer.name, sector: @employer.sector, user_id: @employer.user_id } }
